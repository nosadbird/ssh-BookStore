    ...
    <article>
        ...
        <section>
            ...
            <section class="recommend">
                <h3>《HTML5权威指南》</h3>
                <a href="#"><img src="images/0002.jpg" alt="HTML5权威指南"></a><div class="recommend-content">
                    <p>作为下一代Web标准，
                        <mark>HTML5</mark>
                ...
                <div class="cartmore"><a class="cart" href="detailedcontorll?aim=joincart&&id=0002">加入购物车</a>
                    <a class="more" href="detailedcontorll?id=0002">详细内容</a></div>
            </section>
            <section class="recommend">
                <h3>《JavaScript权威指南》</h3>
                <a href="#"><img src="images/0003.jpg" alt="JavaScript权威指南"></a><div class="recommend-content"><p>经典的JavaScript工具书，从1996年以来，本书已经成为JavaScript程序员心中的《圣经》。</p>
                ...
                <div class="cartmore"><a class="cart" href="detailedcontorll?aim=joincart&&id=0003">加入购物车</a>
                    <a class="more" href="detailedcontorll?id=0003">详细内容</a></div>
            </section>
        </section>
        <!--最近新书-->
        <section class="article-section">
            ...
            <section>
                ...
                <div class="effect-1">
                    ...
                    <div class="text-desc">
                        <h3>《云边有个小卖部》</h3>
                        <p>云边有个小卖部<mark>张嘉佳</mark>2018强力之作，
                                                 悲伤和希望都是一缕光。
                        </p>
                        <br>
                        <a class="btn" href="detailedcontorll?aim=joincart&&id=0004">加入购物车</a> <a class="btn" href="detailedcontorll?id=0004">详细内容</a>
                    </div>
                </div>
            </section><section>
                <h3>《小孩》</h3>
                <div class="effect-1">
                    <div class="image-box">
                        <img src="images/0001.jpg" alt="小孩">
                    </div>
                    <div class="text-desc">
                        <h3>《小孩》</h3>
                        <p>亚马逊中国“年度作家榜华人作家”、新京报“年度致敬作家”<mark>大冰</mark>2019年全新作品。
                                                走过的路越多，越喜欢宅着；见过的人越多，越喜欢孩子。这是一本可以用来下酒的奇书。
                        </p>
                        <br>
                        <a class="btn" href="detailedcontorll?aim=joincart&&id=0001">加入购物车</a> <a class="btn" href="detailedcontorll?id=0001">详细内容</a>
                    </div>
                </div>
            </section>
        </section>
        ...
        <section class="article-section">
            ...
            <section>
                ...
                <a href="#"><img class="promotion" src="images/0005.jpg" alt="HTML5和CSS3实例教程"></a>
                <div><a class="cart" href="detailedcontorll?joinaim=cart&&id=0005">加入购物车</a>
                    <a class="more" href="detailedcontorll?id=0005">详细内容</a></div>
            </section><section>
                <h3>《JavaScript权威指南》</h3>
                <a href="#"><img class="promotion" src="images/0006.jpg" alt="JavaScript权威指南"></a>
                <div><a class="cart" href="detailedcontorll?aim=joincart&&id=0006">加入购物车</a>
                    <a class="more" href="detailedcontorll?id=0006">详细内容</a></div>
            </section>
        </section>
    </article><!--右边边栏区--><aside>
        <!--广告区-->
        ...
        <section class="about">
            ...
            <img src="images/about.gif" alt="有家书店"><p>有家书店成立于2010年6月，是由教育部主管、清华大学主办的综合出版单位。植根于“清华”这座久负盛名的高等学府，秉承清华人“自强不息，厚德载物”的人文精神。</p>
        </section>
    </aside>